...
\label{sec:dnn_classifier}
    ...
    \label{sub:input_features}
        ...
        \begin{itemize}
            ...
            \item $m_{h}\cos\theta$: $\theta$ is the angle between the vector of the reconstructed mass of the Higgs Boson candidates $\left( m_{h_1}, m_{h_2}, m_{h_3} \right) $ and $\left( 120, 115, 110 \right) \text{ GeV}$.
