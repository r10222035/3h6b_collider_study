...
\label{sec:matching_failed_events}
    ...
    \label{sub:delta_r_distance}
        Table~\ref{tab:number_of_quark_match_to_jet} shows that only 76\% event can match all quarks to at least one jet. We modify the $\Delta R$ requirement to study more details about matching failed events.
...
\label{sec:dnn_classifier}
    ...
    \label{sub:input_features}
        ...
        \begin{figure}[htpb]
            \centering
             \subfloat[]{
                 \includegraphics[width=0.97\textwidth]{dR_distribution-abs_pairing.pdf}
            } \\
            \subfloat[]{
                 \includegraphics[width=0.45\textwidth]{rms_dR_distribution-abs_pairing.pdf}
            }
            \subfloat[]{
                 \includegraphics[width=0.45\textwidth]{dA_skew_distribution-abs_pairing.pdf}
            } \\
            \subfloat[]{
                 \includegraphics[width=0.45\textwidth]{HT_distribution-abs_pairing.pdf}
            }
            \subfloat[]{
                 \includegraphics[width=0.45\textwidth]{mhCostheta_distribution-abs_pairing.pdf}
            } \\
            \caption{Distributions of the DNN input features.}
            \label{fig:DNN_input_feature_1}
        \end{figure}
        \begin{figure}[htpb]
            \centering
            \subfloat[]{
                 \includegraphics[width=0.45\textwidth]{eta_mhhh_fraction_distribution-abs_pairing.pdf}
            } \\
            \subfloat[]{
                 \includegraphics[width=0.45\textwidth]{sphericity_distribution-abs_pairing.pdf}
            }
            \subfloat[]{
                 \includegraphics[width=0.45\textwidth]{aplanarity_distribution-abs_pairing.pdf}
            } \\
            \caption{Distributions of the DNN input features.}
            \label{fig:DNN_input_feature_2}
        \end{figure}
        ...
        \begin{figure}[htpb]
            \centering
            \subfloat[Signal]{
                 \includegraphics[width=0.97\textwidth]{dR_distribution_signal.pdf}
            } \\
            \subfloat[Background]{
                 \includegraphics[width=0.97\textwidth]{dR_distribution_background.pdf}
            } \\
            \subfloat[Signal]{
                 \includegraphics[width=0.45\textwidth]{mhCostheta_distribution_signal.pdf}
            }
            \subfloat[Background]{
                 \includegraphics[width=0.45\textwidth]{mhCostheta_distribution_background.pdf}
            } \\
    ...
    \subsection{Training performance}% (fold)
    \label{sub:training_performance}
        ...
        \begin{figure}[htpb]
            \centering
            \subfloat[]{
                 \includegraphics[width=0.45\textwidth]{DNN_loss_resonant.pdf}
            }
            \subfloat[]{
                 \includegraphics[width=0.45\textwidth]{DNN_accuracy_resonant.pdf}
            } \\
        ...
        \begin{figure}[htpb]
            \centering
            \subfloat[]{
                 \includegraphics[width=0.45\textwidth]{DNN_event_score_resonant.pdf}
            }
            \subfloat[]{
                 \includegraphics[width=0.45\textwidth]{DNN_roc_resonant.pdf}
            } \\
            \caption{(a) The event score distribution of the testing dataset. (b) The ROC curve of the testing dataset. The AUC is the area under the ROC curve, and the ACC is the best accuracy.}
            \label{fig:DNN_resonant_event_score_roc}
        \end{figure}

        Table~\ref{tab:DNN_training_results} summarizes the training results of various pairing methods. All methods exhibit similar performance. This suggests that the differences in the input feature distributions are not significant enough to influence the training results.
        \begin{table}[htpb]
            \centering
            \caption{The dense neural network training results. The ACC and AUC are evaluated based on 10 trainings.}
            \label{tab:DNN_training_results}
            \begin{tabular}{l|cc}
            Pairing method   & ACC               & AUC               \\ \hline
            Absolute value   & $0.836 \pm 0.003$ & $0.899 \pm 0.005$ \\
            $\chi^2$         & $0.836 \pm 0.002$ & $0.902 \pm 0.003$ \\
            \textsc{Spa-Net} & $0.831 \pm 0.006$ & $0.900 \pm 0.007$
            \end{tabular}
        \end{table}
    % subsection training_performance (end)
    \subsection{Training performance with larger datasets}% (fold)
    \label{sub:training_performance_with_larger_datasets}
        ...
        \begin{table}[htpb]
            ...
            \end{tabular}
        \end{table}
    % subsection training_performance_with_larger_datasets (end)
    \subsection{4b dataset}% (fold)
    \label{sub:4b_dataset}
        ...
        \begin{table}[htpb]
            ...
            \end{tabular}
        \end{table}
    % subsection 4b_dataset (end)
% section dnn_classifier (end)
...
\label{sec:spanet_classifier}
    ...
    % subsection training_dataset_spanet_classifier (end)
    \subsection{Training results}% (fold)
    \label{sub:training_results_spanet_classifier}
        ...
        \begin{table}[htpb]
            ...
            \end{tabular}
        \end{table}
    % subsection training_results_spanet_classifier (end)
% section spanet_classifier (end)
\section{DNN classifier 2}% (fold)
\label{sec:dnn_classifier_2}
    \subsection{Training performance with 500k datasets}% (fold)
    \label{sub:training_performance_with_500k_datasets}
        ...
        \begin{table}[htpb]
            \centering
            \caption{The dense neural network training results. The ACC and AUC are evaluated based on 10 trainings. 50k means that we use 50k signal and 50k background events.}
            \label{tab:DNN_training_results_50k_100k_500k_4b}
            \begin{tabular}{c|l|cc|cc}
            \multicolumn{1}{l}{}  &                & \multicolumn{2}{c|}{Test on $4b$ datasets} & \multicolumn{2}{c}{Test on $6b$ datasets} \\ \hline
            Sample size           & Pairing method & ACC                 & AUC                 & ACC                 & AUC                 \\ \hline
            \multirow{3}{*}{50k}  & Absolute value   & $0.782 \pm 0.057$ & $0.844 \pm 0.076$ & $0.827 \pm 0.038$   & $0.886 \pm 0.048$   \\
            ...
            \multirow{3}{*}{100k} & Absolute value   & $0.803 \pm 0.005$ & $0.870 \pm 0.006$ & $0.841 \pm 0.003$   & $0.903 \pm 0.003$   \\
                                  & $\chi^2$         & $0.803 \pm 0.005$ & $0.871 \pm 0.005$ & $0.838 \pm 0.003$   & $0.901 \pm 0.002$   \\
                                  & \textsc{Spa-Net} & $0.807 \pm 0.008$ & $0.878 \pm 0.007$ & $0.834 \pm 0.006$   & $0.905 \pm 0.005$   \\ \hline
            \multirow{3}{*}{500k} & Absolute value   & $0.813 \pm 0.007$ & $0.881 \pm 0.012$ & $0.844 \pm 0.007$   & $0.906 \pm 0.008$   \\
                                  & $\chi^2$         & $0.813 \pm 0.004$ & $0.882 \pm 0.005$ & $0.844 \pm 0.003$   & $0.908 \pm 0.004$   \\
                                  & \textsc{Spa-Net} & $0.810 \pm 0.004$ & $0.881 \pm 0.006$ & $0.836 \pm 0.004$   & $0.907 \pm 0.004$
            \end{tabular}
        \end{table}
    % subsection training_performance_with_500k_datasets (end)
    \subsection{Modify hyperparameter}% (fold)
    \label{sub:modify_hyperparameter}
        ...
        \begin{table}[htpb]
            ...
            \end{tabular}
        \end{table}
    % subsection modify_hyperparameter (end)
% section dnn_classifier_2 (end)
\section{Upper limit}% (fold)
\label{sec:upper_limit}
    ...
    \subsection{Event score distribution}% (fold)
    ...
    For dense neural networks, the distributions are similar across various pairing methods. These results are consistent with the similar performance shown in table~\ref{tab:DNN_training_results_500k_4b_256_nodes}. In contrast, the \textsc{Spa-Net} classifier exhibits a different distribution since its accuracy is higher than DNN's by 8\%.
        ...
        \begin{figure}[htpb]
            \centering
            \subfloat[]{
                 \includegraphics[width=0.45\textwidth]{event_score_sig.pdf}
            }
            \subfloat[]{
                 \includegraphics[width=0.45\textwidth]{event_score_bkg.pdf}
            }
            \caption{The $p_{\text{event}}$ distribution with various selection methods.}
            \label{fig:event_score_distribution}
        \end{figure}

    % subsection event_score_distribution (end)
...
% section upper_limit (end)
\section{Organize generated samples}% (fold)
\label{sec:organize_generated_samples}
    ...
    \subsection{Event classifier}% (fold)
    \label{sub:event_classifier}
        ...
        \begin{table}[htpb]
            ...
            \end{tabular}
        \end{table}
    % subsection event_classifier (end)
    \subsection{Upper limit constraints}% (fold)
    \label{sub:upper_limit_constraints}
        ...
        \begin{table}[htpb]
            ...
            \end{tabular}
        \end{table}
    % subsection upper_limit_constraints (end)
% section organize_generated_samples (end)
\section{Different signal benchmarks}% (fold)
\label{sec:different_signal_benchmarks}
    ...
    \subsection{Event classifier with mixed datasets}% (fold)
    \label{sub:event_classifier_with_mixed_datasets}
        ...
        \begin{table}[htpb]
            ...
            \end{tabular}
        \end{table}
    % subsection event_classifier_with_mixed_datasets (end)
    \subsection{Performance at different mass points}% (fold)
    \label{sub:performance_at_different_mass_points}
        ...
        \begin{figure}[htpb]
            \centering
            \subfloat[]{  
                \includegraphics[width=0.45\textwidth]{pairing_performance-4b_datasets.pdf}  
            }  
            \subfloat[]{  
                \includegraphics[width=0.45\textwidth]{pairing_performance-6b_datasets.pdf}  
            }  
        ...
        \begin{figure}[htpb]
            \centering
            \subfloat[]{  
                \includegraphics[width=0.45\textwidth]{classification_performance-4b_datasets.pdf}  
            }  
            \subfloat[]{  
                \includegraphics[width=0.45\textwidth]{classification_performance-6b_datasets.pdf}  
            }  
        ...
        \end{figure}
    % subsection performance_at_different_mass_points (end)  
% section different_signal_benchmarks (end)
\section{New version of SPANet}% (fold)
...
% section new_verion_of_spanet (end)
\section{More mass points}% (fold)
...
% section more_mass_points (end)
\section{Two Real Singlet Model (TRSM)}% (fold)
\label{sec:two_real_singlet_model_trsm_}
    ...
    \begin{table}[htpb]
        ...
        \end{tabular}
    \end{table}
    \subsection{Event classifier with mixed datasets in TRSM}% (fold)
    \label{sub:event_classifier_with_mixed_datasets_in_trsm}
       The $4b$ datasets consist of events from 4 benchmark points: $(m_{h_3}, m_{h_2}) = $ (420, 280), (500, 275), (500, 300), (520, 325) GeV. The number of events for each mass point is 250k, and the total size of the $4b$ datasets is 1M.
        ...
        \begin{table}[htpb]
            ...
            \end{tabular}
        \end{table}
    % subsection event_classifier_with_mixed_datasets_in_trsm (end)
    \subsection{Performance at different mass points}% (fold)
    \label{sub:performance_at_different_mass_points}
        We evaluate the pairing and classification performance at each mass point to investigate the detailed results for mixed datasets.
        ...
        \begin{figure}[htpb]
            \centering
            \subfloat[]{  
                \includegraphics[width=0.45\textwidth]{pairing_performance-4b_datasets-TRSM.pdf}  
            }  
            \subfloat[]{  
                \includegraphics[width=0.45\textwidth]{pairing_performance-6b_datasets-TRSM.pdf}  
            }  
        ...
        \begin{figure}[htpb]
            \centering
            \subfloat[]{  
                \includegraphics[width=0.45\textwidth]{classification_performance-TRSM-4b_datasets.pdf}  
            }  
            \subfloat[]{  
                \includegraphics[width=0.45\textwidth]{classification_performance-TRSM-6b_datasets.pdf}  
            }  
            \caption{Classification performance at different mass points. The AUCs of different classifiers are evaluated. Both \textsc{Spa-Net} and Dense-NNs are trained on the mixed datasets described in Section~\ref{sub:event_classifier_with_mixed_datasets}.}  
            \label{fig:classification_performance_each_mass_point-TRSM}  
        \end{figure}
    % subsection performance_at_different_mass_points (end) 
% section two_real_singlet_model_trsm_ (end)
\section{Enlarge the training samples for TRSM}% (fold)
\label{sec:enlarge_the_training_samples_for_trsm}
    ...
    \label{sub:performance_at_different_mass_points}
        ...
        \begin{figure}[htpb]
            \centering
            \subfloat[]{  
                \includegraphics[width=0.45\textwidth]{pairing_performance-4b_datasets-750k-TRSM.pdf}
            }
            \subfloat[]{
                \includegraphics[width=0.45\textwidth]{pairing_performance-6b_datasets-750k-TRSM.pdf}
            }
        ...
        \end{figure}
    % subsection performance_at_different_mass_points (end)
% section enlarge_the_training_samples_for_trsm (end)
\section{TRSM: 5 mass points}% (fold)
\label{sec:trsm_5_mass_points}
    ...
    \label{sub:performance_at_different_mass_points}
        ...
        \begin{figure}[htpb]
            \centering
            \subfloat[]{  
                \includegraphics[width=0.45\textwidth]{pairing_performance-4b_datasets-mix_5-250k-TRSM.pdf}
            }
            \subfloat[]{
                \includegraphics[width=0.45\textwidth]{pairing_performance-6b_datasets-mix_5-250k-TRSM.pdf}
            }
        ...
        \begin{figure}[htpb]
            \centering
            \subfloat[]{  
                \includegraphics[width=0.45\textwidth]{classification_performance-TRSM-4b_datasets-mix_5-250k.pdf}  
            }  
            \subfloat[]{  
                \includegraphics[width=0.45\textwidth]{classification_performance-TRSM-6b_datasets-mix_5-250k.pdf}  
            }  
        ...
        \end{figure}
    % subsection performance_at_different_mass_points (end)
    \subsection{Upper limit of cross-section}% (fold)
    \label{sub:upper_limit_of_cross_section}
        ...
        \end{figure}
    % subsection upper_limit_of_cross_section (end)
% section trsm_5_mass_points (end)
\section{TRSM: 5 mass points, 1M datasets}% (fold)
\label{sec:trsm_5_mass_points_1m_datasets}
    ...
    \label{sub:performance_at_different_mass_points}
        ...
        \begin{figure}[htpb]
            \centering
            \subfloat[]{  
                \includegraphics[width=0.45\textwidth]{pairing_performance-4b_datasets-mix_5-1M-TRSM.pdf}
            }
            \subfloat[]{
                \includegraphics[width=0.45\textwidth]{pairing_performance-6b_datasets-mix_5-1M-TRSM.pdf}
            }
        ...
        \begin{figure}[htpb]
            \centering
            \subfloat[]{  
                \includegraphics[width=0.45\textwidth]{classification_performance-TRSM-4b_datasets-mix_5-1M.pdf}  
            }  
            \subfloat[]{  
                \includegraphics[width=0.45\textwidth]{classification_performance-TRSM-6b_datasets-mix_5-1M.pdf}  
            }  
            \caption{Classification performance at different mass points. The AUCs of different classifiers are evaluated. Both \textsc{Spa-Net} and Dense-NNs are trained on the mixed datasets described in Section~\ref{sec:trsm_5_mass_points}.}  
    ...
    \label{sub:upper_limit_of_cross_section}
        ...
        \end{figure}
    % subsection upper_limit_of_cross_section (end) 
    \subsection{Update the upper limit}% (fold)
    \label{sub:update_the_upper_limit}
        ...
        \end{figure}
    % subsection update_the_upper_limit (end)
    \subsection{Modified the Dense-NN training setting}% (fold)
    \label{sub:modified_the_dense_nn_training_setting}
        To make a fari comparison with ATLAS results, we change the number of hidden nodes to 24 for each layer. We reduced the training sample size to 900k, such the number of background event is closed to 5b data. The class weights are also added.  
        ...
        \begin{figure}[htpb]
            \centering
            \subfloat[]{  
                \includegraphics[width=0.45\textwidth]{classification_performance-TRSM-4b_datasets-mix_5-150k-24_nodes.pdf}  
            }  
            \subfloat[]{  
                \includegraphics[width=0.45\textwidth]{classification_performance-TRSM-6b_datasets-mix_5-150k-24_nodes.pdf}
            }  
            \caption{Classification performance at different mass points. The AUCs of different classifiers are evaluated. Both \textsc{Spa-Net} and Dense-NNs are trained on the mixed datasets described in Section~\ref{sec:trsm_5_mass_points}.}  
        ...
        \end{figure}
    % subsection modified_the_dense_nn_training_setting (end)
% section trsm_5_mass_points_1m_datasets (end)
