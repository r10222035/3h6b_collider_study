...
\label{sec:two_real_singlet_model_trsm_}
    ...
    Table~\ref{tab:preselection_cutflow_number_trsm_420_280} is the cutflow number at different selection cuts.
    \begin{table}[htpb]
        \centering
        \caption{The number of passing events, efficiencies, and passing rates for signal processes at different selection cuts.}
        ...
        \begin{tabular}{l|rrr}
                                                         & Count  & Efficiency & Pass rate \\ \hline
        Total                                            & 10000 & 1.00       & 1.00      \\
        $\ge 6$ jets                                     &  6081 & 0.61       & 0.61      \\
        $\ge 4$ jets with $p_{\text{T}} > \text{40 GeV}$ &  4986 & 0.82       & 0.50      \\
        $\ge 4$ $b$-jets                                 &  3203 & 0.64       & 0.32      \\ \hline
        Matching 3h                                      &  1018 & 0.32       & 0.10      \\
        Matching 2h                                      &  1102 & 0.34       & 0.11      \\
        Matching 1h                                      &   860 & 0.27       & 0.09      \\
        \end{tabular}
    \end{table}
