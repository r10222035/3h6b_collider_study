...
\label{sec:dnn_classifier}
    ...
    \label{sub:input_features}
        ...
        \begin{itemize}
            ...
            \item $\text{rms } \Delta R_{\text{dijet}}$: The root mean square of the angular distance between all possible dijet that can form a Higgs Boson candidate. We consider all possible permutations of 6 jets selected for pairing.
        ...
        Figure~\ref{fig:DNN_input_feature_various_pairing_method} is the input feature distribution of various pairing methods. Since the distribution of $\Delta R_{h_i}$ and $m_{h} \cos\theta$ depend on the pairing results, we show the plots of these two variables.
        \begin{figure}[htpb]
            \centering
            \subfloat[Signal]{
            ...
            \caption{Distributions of $\Delta R_{h_i}$ and $m_{h} \cos\theta$.}
