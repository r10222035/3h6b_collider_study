...
\section{SPANet 2.2}% (fold)
\label{sec:spanet_2_2}
    The latest version of \textsc{Spa-Net} is 2.2. Previously, I used version 2.0 for \textsc{Spa-Net} training. After installing the updated code from GitHub, I trained \textsc{Spa-Net} using $t \overline{t}$ datasets. The results obtained with version 2.2 show a slight improvement over version 2.0, with an accuracy increase of less than 0.5\%. The performance difference between the two versions is not significant.
% section spanet_2_2 (end)
